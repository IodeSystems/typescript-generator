...
import com.iodesystems.ts.Asserts.assertEq
import com.iodesystems.ts.Asserts.assertIsEmpty
import com.iodesystems.ts.Asserts.assertNonNull
import com.iodesystems.ts.Asserts.assertSingle
import com.iodesystems.ts.Asserts.assertSingleKey
import com.iodesystems.ts.Asserts.assertType
import com.iodesystems.ts.Asserts.toJson
...
import com.iodesystems.ts.model.TsRefNew
...
class ExtractorTest {
    ...
    fun types() {
        ...
        extraction.typeReferences.assertSingle("There should be a single reference").let { ref ->
            ...
            ref.refType.assertEq(TsRefNew.Type.METHOD, "Reference from is invalid")
        }
        extraction.types
            .assertSingle("There should be a single request type")
            .assertType<TsTypeNew.Object>("Request type is the wrong type")
            .let { type ->
    ...
    fun simpleArrays() {
        ...
        extraction.apis.assertSingle("There should be one api extracted")
            ...
            .let { method ->
                method.requestBodyType
                    ...
                    .assertType<TsTypeNew.Inline>("Request type is invalid")
                    .let { req ->
        ...
        extraction.types.assertSingle("There should be a single type")
            .assertType<TsTypeNew.Object>("Should be an object")
            .let { el ->
        ...
        ext.apis.assertSingle("There should be one api extracted")
            ...
            .let { method ->
                method.responseBodyType
                    ...
                    .assertType<TsTypeNew.Inline>("Response type is invalid")
                    .let { resp ->
